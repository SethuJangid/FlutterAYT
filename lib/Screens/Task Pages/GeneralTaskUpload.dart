...
class GeneralTaskUpload extends StatefulWidget {
  String name;
  String task_id;
  GeneralTaskUpload({this.name,this.task_id});
  @override
  _GeneralTaskDetailPageState createState() => _GeneralTaskDetailPageState();
}

class _GeneralTaskDetailPageState extends State<GeneralTaskUpload> {
  ...
  Future profileUpload(String uniqId,String tskID,BuildContext context) async {
    print("Employee ID---->"+uniqId);
    print("Description---->"+description);
    print("Task ID---->"+tskID);
