...
class _OTPScreenState extends State<OTPScreen> {
          ...
          child: ListView(
              children: <Widget>[
                Container(
                  ...
                  child: Image.asset(
                    AppConfig.appIcon==null?
                    AppConfig.appIconDefault:AppConfig.appIcon,
                              ...
                              children: <Widget>[
                                ...
                                Center(child:Container(
                                  ...
                                  child:PinEntryTextField(
                                    showFieldAsBox: true,
                                    lastPin: widget.opt,
                                    boxColor: AppConfig.appColorMain,
                                    textColor: AppConfig.fontColor,
                                    onSubmit: (otp){
                                       CheckOTP=otp;
                                  ...
                                  onPressed: () {
                                    ...
                                    if(CheckOTP!=null && CheckOTP==widget.opt){
                                      ...
                                      Scaffold.of(context)
                                          ...
                                          'Your OTP is not Correct'),backgroundColor: AppConfig.snackBarELSEColor,));
  ...
  Future<MainProfileModel> otpCheck(String opt1, String phone1,String fcmid,BuildContext context) async {
    ...
    if(response.statusCode == 200){
      ...
      Scaffold.of(context)
          .showSnackBar(SnackBar(content: Text(
          'Your Are Sucessfully Register'),backgroundColor: AppConfig.snackBarIFColor,));
      ...
      Scaffold.of(context)
          .showSnackBar(SnackBar(content: Text(
          'Your OTP is Not Correct'),backgroundColor: Colors.red,));
      /*final snackBar = SnackBar(content: Text('Your OTP is Not Correct',style: TextStyle(fontWeight: FontWeight.bold),),backgroundColor: Colors.red,);
      ScaffoldMessenger.of(context).showSnackBar(snackBar);*/
