    ...
    return haveUserSearched ? ListView.builder(
      ...
      itemCount: searchResultSnapshot.documents.length,
        ...
        return userTile(
          ...
          searchResultSnapshot.documents[index].data()["userImage"],
        );
        }) : Container();
  }
  ...
  sendMessage(String userName){
    ...
    Navigator.push(context, MaterialPageRoute(
      builder: (context) => Chat2(
        chatRoomId: chatRoomId,
        userName: userName,
        userImage: userImage==null?detualtImage:userImage,
      )
    ));

  }

  Widget userTile(String userName,String userEmail,String userImage){
    return Card(
      elevation: 8,
      child: Container(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "SEARCH LIST",
          style: TextStyle(fontSize: 20,color: AppConfig.appBarTextColor),
        ),
        elevation: 0.0,
      ),
