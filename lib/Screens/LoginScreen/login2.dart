...
class _MyLoginState extends State<MyLogin2> {
                                  ...
                                  onPressed: () {
                                    if(_textEditingController.text.isNotEmpty&&_textEditingController.text.length==10){
                                      ...
                                      Scaffold.of(context).showSnackBar(SnackBar(content: Text(
                                          'Field Required Or Mobile No is Not Correct'),backgroundColor: AppConfig.snackBarELSEColor,));
                                    }
  ...
  void logg(String phnno,BuildContext context) async {
    ...
    if (response.statusCode == 200) {
      ...
      Scaffold.of(context)
          ...
          'Your Mobile No is Not Register'),backgroundColor: Colors.red,));
