...
class checkIN_OUTState extends State<checkIN_OUT> {
  ...
  getData()async{
    ...
    setState(() {
      ...
      attendanceTimeCheckOut = sharedPreferences.getString("statusCode");
  ...
  Future _scanQR(String action1,BuildContext buildContext) async {
    try {
      String qrResult = await BarcodeScanner.scan();
      setState(() {
        result = qrResult;
        print(result);
        chech_in_out(action1,buildContext);
      });
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Visibility(
          visible: statusCode!=200?true:false ,
          child: Row(
  ...
  void chech_in_out(String action,BuildContext context) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        Scaffold.of(context)
            ...
            checkINmsg),backgroundColor: Colors.green,));
        ...
        sharedPreferences.setString("statusCode", statusCode.toString());
      ...
      Scaffold.of(context)
          .showSnackBar(SnackBar(content: Text(
          checkINmsg),backgroundColor: Colors.red,));
    }
  }
}